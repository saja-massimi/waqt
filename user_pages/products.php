        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="bg-light p-4 mb-30">
                    ...
                    <input type="range" class="form-range" id="priceRange" min="0" max="1000" value="50" step="10">
                    </form>
                </div>
                <!-- Price End -->
                ...
                <div class="bg-light p-4 mb-30">
                    ...
                    <form method="GET" action="">
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" id="all" selected>
                ...
                <div class="bg-light p-4 mb-30">
                    <form>
                        ...
                        <?php
                        //add a php code to display brands from the database
                        ?>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" checked id="allBrands" selected>
                            <label class="custom-control-label" for="allMaterials">All Brands</label>
                        </div>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                ...
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Filter by Strap Material</span></h5>
                <div class="bg-light p-4 mb-30">
                    <form>
                        ...
                        ?>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" checked id="allMaterials" selected>
                            <label class="custom-control-label" for="allBrands">All Materials</label>
                        </div>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" id="leather">
                            <label class="custom-control-label" for="leather">Leather</label>
                        </div>
