            ...
            <div class="card h-100">
              <div class="card-body">
                ...
                <div class="social-icons">
                  <a href="https://github.com/Sohiub-Bataina" class="card-link"><i class="fa-brands fa-square-github"></i></a>
                  <a href="https://www.linkedin.com/in/sohiub-bataineh" class="card-link"><i class="fa-brands fa-linkedin"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-2 mb-4">
            <div class="card h-100">
              <div class="card-body">
                ...
                <div class="social-icons">
                  <a href="https://github.com/saja-massimi" class="card-link"><i class="fa-brands fa-square-github"></i></a>
                  <a href="https://www.linkedin.com/in/saja-al-massimi/" class="card-link"><i class="fa-brands fa-linkedin"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-2 mb-4">
            <div class="card h-100">
              <div class="card-body">
                ...
                <div class="social-icons">
                  <a href="" class="card-link"><i class="fa-brands fa-square-github"></i></a>
          ...
          <div class="col-md-2 mb-4 ">
            <div class="card h-100">
              <div class="card-body">
                ...
                <p class="card-text">Software Engineer <br><span>Full Stack</span></p>
                <div class="social-icons">
                  <a href="https://github.com/asma-marar" class="card-link"><i class="fa-brands fa-square-github"></i></a>
                  <a href="https://www.linkedin.com/in/asma-marar-5a3aba197/" class="card-link"><i class="fa-brands fa-linkedin"></i></a>
                </div>
              </div>
            </div>
          </div>
